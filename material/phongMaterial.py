    ...
    def __init__(self, texture=None, properties={}, bumpTexture=None, useShadow=False):
        ...
        vertexShaderCode="""
            ...
            void main()
            {
                ...
                if(useShadow)
                {
                    vec4 temp0 = (shadow0.projectionMatrix * shadow0.viewMatrix * modelMatrix *
                                    vec4(vertexPosition, 1));
        ...
        fragmentShaderCode="""
            ...
            void main()
            {
                ...
                if(useBumpTexture) bNormal += bumpStrength * vec3(texture2D(bumpTexture, UV));
                ...
                if (useShadow)
                {
                    ...
                    float closestDistanceToLight = texture2D(shadow0.depthTexture, 
                                                                shadowCoord.xy).r;
