...
class Database:
    ...
    def initialize(self):
        ...
        cur.execute('''DROP TABLE itemcodes''')
        cur.execute('''DROP TABLE cartons''')
        ...
        cur.execute('''INSERT INTO cartons VALUES ('A500', 240, 155, 360)''')
        ...
        #cur.execute('''INSERT INTO containers VALUES ('TWENTY', 2195, 2100, 5300)''') #original height size
        #cur.execute('''INSERT INTO containers VALUES ('FORTY', 2195, 2100, 11300)''')

        cur.execute('''INSERT INTO containers VALUES ('TWENTY', 2300, 2100, 5300)''') #increased the height to make sure cartons could get in
        ...
        cur.execute('''INSERT INTO itemcodes VALUES ('14000', 'C174')''')
        ...
        cur.execute('''INSERT INTO itemcodes VALUES ('14051', 'C205')''')
        ...
        cur.execute('''INSERT INTO itemcodes VALUES ('14257', 'C115')''')
