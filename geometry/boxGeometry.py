...
class BoxGeometry(Geometry):
    ...
    def __init__(self, width=1, height=1, depth=1, 
                color = [[1,0.5,0.5],[0.5,0,0],[0.5,1,0.5],
                         [0,0.5,0],[0.5,0.5,1],[0,0,0.5]]):
        super().__init__()
        ...
        C4, C5, C6 = color[3], color[4], color[5]
        ...
        positionData = [P5,P1,P3, P5,P3,P7, P0,P4,P6, P0,P6,P2, P6,P7,P3, P6,P3,P2, 
                        P0,P1,P5, P0,P5,P4, P4,P5,P7, P4,P7,P6, P1,P0,P2, P1,P2,P3]
