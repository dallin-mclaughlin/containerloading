...
class Renderer(object):
    ...
    def render(self, scene, camera, clearColor=True, clearDepth=True, renderTarget=None):
        ...
        if self.shadowsEnabled:
            ...
            #everything in the scene gets rendered with depthMaterial so only need to call 
            #glUseProgram & set matrices once
        ...
        lightList = list(filter(lightFilter, descendentList))
        #scenes support 4 light; precisely 4 must be present
