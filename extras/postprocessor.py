...
class Postprocessor(object):
    ...
    def __init__(self, renderer, scene, camera, finalRenderTarget=None):
        ...
        self.orthoCamera.setOrthographic() #aligned with clipspace by default
    ...
    def addEffect(self, effect):
        ...
        #change the previous entry in the render target list to this newly created render 
        #target
        self.renderTargetList[-1] = target

        #the effect in this render pass will use the texture that was written to in the 
